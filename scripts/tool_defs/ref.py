...
d('docker-commands', 'Docker 命令大全', 'Docker 命令 + Dockerfile 指令大全：镜像 / 容器 / 网络 / 卷 / 编排，点击复制', js=SEARCH_JS + r'''
var DATA = [
